...
6. Optionally check "Recruit through Prolific", and leave the participant
   ...
   adds it again. Then the address holds the parameter twice, once as the
   placeholder and once filled, and the page reads the filled value.
