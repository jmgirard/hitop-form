...
The hitop package's reader reads the three CSV files in its own tests. A change
to the page's file layout shows up there as well as here. `.gitattributes`
keeps their CRLF row endings as the page writes them.
